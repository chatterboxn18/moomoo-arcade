...
public class LWReminderItem : MonoBehaviour
{
	...
	[SerializeField] private TextMeshProUGUI _typeReminder;
	...
	public void SetReminder(string time, int index, int[] notifications, bool isActive)
	{
...
#if UNITY_ANDROID
				var notification = LWNotificationManager.CreateNotification(LWNotificationManager.NotificationType.Water, dateTime);
